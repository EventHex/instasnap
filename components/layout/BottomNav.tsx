...
import { Home, ScanFace, Images, User, LogOut, ImageIcon, Users } from 'lucide-react';
...
export function BottomNav() {
    ...
    const navItems = [
        ...
        { href: '/people', icon: <Users className="w-6 h-6" />, label: 'People', show: true, isButton: false },
